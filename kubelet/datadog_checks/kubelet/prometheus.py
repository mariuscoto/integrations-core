...
class CadvisorPrometheusScraper(PrometheusScraper):
    ...
    def _get_container_id(self, labels, with_scheme=False):
        """
        ...
        return self.pod_list_utils.get_cid_by_name_tuple((namespace, pod_name, container_name), with_scheme)

    def _get_container_id_if_container_metric(self, labels, with_scheme=True):
        """
        ...
        if CadvisorPrometheusScraper._is_container_metric(labels):
            return self._get_container_id(labels, with_scheme)
